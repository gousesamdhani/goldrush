 ...
 */
class Materials_Master extends CI_Model {
    ...
    public function getAllMaterials($where_array) {
    	try {
    		//print_r($where_array);exit();
			$this->db->select('id, name, cost, unit, row_status as status');
			$this->db->from($this->materials_master);
