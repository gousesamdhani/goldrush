...
*/
	Function GetAccessToken(&$access_token)
	{
		...
		if(!$this->GetAccessTokenURL($access_token_url))
			return false;
		if(isset($GLOBALS['fitbit_access_token']) && $GLOBALS['fitbit_access_token']!="" )
		{
			//echo FITBIT_ACCESS_TOKEN;exit; 
            $acc_token_array=unserialize($GLOBALS['fitbit_access_token']);
            //echo "<pre>";print_r($acc_token_array);exit;
            $access_token = $acc_token_array[$access_token_url];
...
*/
	...
	Function SendAPIRequest($url, $method, $parameters, $oauth, $options, &$response)
	{
		...
		$arguments['Headers']['Accept-Language'] = (IsSet($options['Accept-Language']) ? $options['Accept-Language'] : 'en_US');
...
*/
	...
	{
		//echo $url." ".$method." ".print_r($parameters)." ".print_r($options);exit;
		...
		echo "Parameters:".print_r($parameters)."<br/>";
		echo "Oauth:".print_r($oauth)."<br/>";
		echo "Options:".print_r($options)."<br/>";
		echo "Options:".print_r($response)."<br/>";
		exit;*/
...
*/
	Function Initialize()
	{
		...
		switch($this->server)
		{
			...
			default:
			    //$this->configuration_file=dirname(__FILE__)."/".$this->configuration_file;
