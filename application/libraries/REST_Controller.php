    ...
    */
    ...
    protected function _prepare_basic_auth()
    {
        ...
        $password = null;
		 ...
		 // mod_php
        if ($this->input->post('service_username')) {
            $username = $this->input->post('service_username');
            $password = $this->input->post('service_password');
        }
		
        // mod_php
        elseif ($this->input->server('PHP_AUTH_USER')) {
