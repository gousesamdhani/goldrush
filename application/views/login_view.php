...
<head>
	...
	<title>User Login Form | Gold Merchants</title>
...
<div class="container">
	<div class="row">
		...
		<?php $attributes = array("name" => "loginform");
			echo form_open("user_login", $attributes);?>
			<legend>Login</legend>
			<div class="form-group">
				<label for="name">Mobile number</label>
				<input class="form-control" name="phone" placeholder="Enter mobile number" type="text" value="<?php echo set_value('phone'); ?>" />
	...
	<div class="row">
		...
		New User? <a href="<?php echo base_url(); ?>user_signup">Sign Up Here</a>
		</div>
	</div>
</div>
